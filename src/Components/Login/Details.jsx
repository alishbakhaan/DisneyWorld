...
//           {/* <!-- product Side --> */}
//           <div className="relative flex order-2 lg:order-1 bg-[url('./assets/images/bgra.png')] bg-cover lg:bg-contain bg-no-repeat mt-32 lg:mt-0 rounded-3xl w-full lg:w-1/2 lg:h-full">
...
//             {/* <div className="lg:block hidden bg-white ml-auto w-1/3"></div> */}
...
//             <div className="relative z-10 flex items-center form-wrapper px-10 pt-16 lg:pt-0 lg:h-full">
...
//                     <input type="email" name="" id="" placeholder="Enter Email Address" className="bg-white focus:bg-white opacity-50 mt-2 px-4 py-3 border focus:border-blue-500 rounded-lg w-full // focus:outline" autofocus autocomplete required onChange={getdata}/>
//                   </div>
//                   {/* <!-- form element --> */}
...
//                     <input type="password" name="" id="" placeholder="Enter Password" minlength="6" className="bg-white focus:bg-white opacity-50 mt-2 px-4 py-3 border focus:border-blue-500 rounded-lg w-full // focus:outline" required onChange={getdata}/>
//                   </div>
//                   {/* <!-- form element --> */}
...
//                   <button onClick={addData}  type="submit" className="block bg-blue-500 hover:bg-blue-400 focus:bg-blue-400 mt-6 py-3 rounded-lgpx-4 w-full font-semibold text-white">Log In</button>
//                   {/* <!-- form element --> */}
...
//         </div>
//         <video autoPlay loop muted class="absolute w-auto min-w-full max-w-none min-h-full" src={video}></video>
//       </div>
